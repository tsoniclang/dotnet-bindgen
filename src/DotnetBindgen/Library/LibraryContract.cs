...
namespace DotnetBindgen.Library;

/// <summary>
/// Represents the contract defined by an existing dotnet-bindgen library package.
...
public sealed record LibraryContract
{
    ...
    ///
    /// Airplane-grade: dotnet-bindgen will only error if an ambiguous CLR type is actually referenced during
