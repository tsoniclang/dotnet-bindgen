...
/// <summary>
/// Loads a LibraryContract from an existing dotnet-bindgen package directory.
...
public static class LibraryContractLoader
{
    ...
    /// </summary>
    /// <param name="packagePath">Path to existing dotnet-bindgen package directory</param>
