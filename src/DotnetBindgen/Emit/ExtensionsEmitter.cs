...
public static class ExtensionsEmitter
{
    ...
    private static string GenerateExtensionsFile(BuildContext ctx, ExtensionMethodsPlan plan, SymbolGraph graph)
    {
        ...
        // File header
        sb.AppendLine("// Generated by dotnet-bindgen - Extension Method Tables");
        ...
        HashSet<string> visited)
    {
        ...
        //
        // For many CLR types (e.g., ParallelQuery<T>), interface members are implemented explicitly, so dotnet-bindgen
