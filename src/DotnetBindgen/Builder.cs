...
using DotnetBindgen.Core.Policy;
using DotnetBindgen.Load;
...
public static class Builder
{
    ...
    /// <param name="libraryPackagePaths">Paths to existing dotnet-bindgen packages for library mode (empty = normal mode)</param>
