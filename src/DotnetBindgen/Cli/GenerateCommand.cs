...
public static class GenerateCommand
{
    public static Command Create()
    {
        ...
        var libOption = new Option<string[]>(
            name: "--lib",
            description: "Path to existing dotnet-bindgen package (library mode - emit only what's in the library contract, repeatable)")
        {
            AllowMultipleArgumentsPerToken = false,
            Arity = ArgumentArity.ZeroOrMore
        };
        ...
        var surfacePackageOption = new Option<string[]>(
            ...
            description: "Path to dotnet-bindgen surface package config (repeatable)")
        {
            AllowMultipleArgumentsPerToken = false,
            Arity = ArgumentArity.ZeroOrMore
        };
