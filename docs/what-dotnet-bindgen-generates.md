---
title: What dotnet-bindgen Generates
---

# What dotnet-bindgen Generates

`dotnet-bindgen` reflects CLR metadata and emits TypeScript declaration packages.
...
The stack does **not** treat `dotnet-bindgen` as the source generator for:
