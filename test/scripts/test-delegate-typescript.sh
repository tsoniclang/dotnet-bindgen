...
// Branded int type (as generated by dotnet-bindgen)
...
const a: Action<int> = (x: int) => { /* no-op */ };
a(1 as int);
...
const directAction: Internal.Action_1<string> = (s: string) => { /* no-op */ };
directAction("hello");
...
// All TypeScript compile tests passed!
EOF
